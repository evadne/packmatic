defmodule Packmatic.Field.Helpers do
  ...
  defguard fits_u8(value) when is_number(value) and value < 256
  defguard fits_u16(value) when is_number(value) and value < 65_536
  defguard fits_u32(value) when is_number(value) and value < 4_294_967_296
  defguard fits_u64(value) when is_number(value) and value < 18_446_744_073_709_551_616
